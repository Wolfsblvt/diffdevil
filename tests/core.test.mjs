...
const fixture = name => JSON.parse(readFileSync(new URL(`../examples/reports/${name}.json`, import.meta.url), 'utf8'));
...
for (const row of JSON.parse(readFileSync(new URL('../spec/detail/v1/conformance/paths.json', import.meta.url))).cases) {
