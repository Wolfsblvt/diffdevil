...
const data = name => JSON.parse(readFileSync(new URL(`../spec/detail/v1/conformance/${name}.json`, import.meta.url))).cases;
const report = name => JSON.parse(readFileSync(new URL(`../examples/reports/${name}.json`, import.meta.url)));
