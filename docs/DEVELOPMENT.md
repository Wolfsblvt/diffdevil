...
| `npm run verify` | Preparation, ordinary build, all registered core and `apps/**/*.test.mjs` application cases, and exact Action regeneration parity. |
...
engine through an AGPL application server, versioned response schema, browser assets and
application-owned tests; it is not part of the npm or Action distributions.
