...
| `npm run check:website` | Generates the manual collection from the docs manifest and builds the public website into `artifacts/website/dist`. Part of `verify`. It deploys, previews remotely or exposes nothing. |
