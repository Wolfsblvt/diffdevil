...
**Sources.** [Release Work #459](https://github.com/Wolfsblvt/emergency-meeting/issues/459), D014, the inspected npm file list, [npm package licence metadata](https://docs.npmjs.com/files/package.json/#license), and [Creative Commons legal code](https://creativecommons.org/licenses/by/4.0/legalcode).
