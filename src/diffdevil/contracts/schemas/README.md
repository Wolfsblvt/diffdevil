...
- [Typed values](../detail/v1/values.schema.json): numeric evidence, decisions, and recursive query values.
- [Internal AST](../detail/v1/ast.schema.json): compiler/test structure, not a public persisted program.
...
The package's [qualification evidence](../../../../docs/QUALIFICATION.md) states which structural, semantic and consumer checks executed and which boundaries remain unobserved.
