...
const report=name=>resolve(root,`docs/examples/reports/${name}.json`);
...
const cases=JSON.parse(readFileSync(resolve(root,'src/diffdevil/contracts/detail/v1/conformance/shortcuts.json'))).cases;
...
test('shortcut catalogs match the maintained machine contract',()=>{
 const catalog=JSON.parse(readFileSync(resolve(root,'src/diffdevil/contracts/detail/v1/shortcuts.json')));
