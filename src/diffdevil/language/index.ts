...
export type { CompiledExpression, CompileOptions } from './compile.js';
export { compileShortcut, expandShortcut } from './shortcuts.js';
export type { Shortcut } from './shortcuts.js';
...
export type { EvaluationEnvironment } from './environment.js';
