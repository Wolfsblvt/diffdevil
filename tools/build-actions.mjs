...
const runtime = join(temporary, 'actions/runtime');
try {
  ...
  for (const entry of ENTRY_POINTS) {
    ...
    if (entry !== 'root') await writeFile(join(directory, 'index.mjs'), `// Generated by tools/build-actions.mjs; all behavior lives in the shared runtime.\nimport '../runtime/lib/actions/${entry}.js';\n`);
    const metadata = {
