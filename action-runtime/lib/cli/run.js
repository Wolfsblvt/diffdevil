...
export function runCli(argv, defaultCwd = process.cwd(), host = {}) {
    return captureAsync(async () => {
        ...
        if (v.help)
            ...
            const kinds = { report: 'schemas/report-v1.schema.json', config: 'schemas/policy-v1.schema.json', query: 'schemas/query-result-v1.schema.json', plan: 'schemas/plan-v1.schema.json', language: 'spec/detail/v1/profile.json', metrics: 'spec/detail/v1/shortcuts.json' };
