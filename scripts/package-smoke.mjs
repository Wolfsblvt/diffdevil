...
assert.ok(paths.includes('schemas/report-v1.schema.json'));
for (const path of ['docs/guides/auto-label-pull-requests.md', 'docs/guides/local-automation.md', 'examples/diffs/review.diff', 'examples/policies/review-signals.yml', 'reference/README.md']) {
...
await writeFile(join(home, 'github-fixture.mjs'), await readFile(resolve(root, 'tests/helpers/github.mjs'), 'utf8'));
