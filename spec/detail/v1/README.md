...
These assets encode the selected finite language contract for `diffdevil-expr/1`: grammar, tokens, operators, functions, input catalogs, diagnostics, limits, value/AST shapes, API declarations, and conformance cases. They are implementation groundwork, not a running parser or substitute for the maintained semantic reference.
