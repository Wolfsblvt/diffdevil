# Historical policy shortcuts return

## Meaning

This public evidence edition preserves the substantive policy shortcuts
...
YAML loading, the Action runner and its provider effects remain unimplemented.
