...
This notice describes the browser extension’s implemented data handling. It does not cover GitHub’s own service or the independent diffdevil GitHub App. This source candidate is not a published Chrome Web Store listing.
...
Incognito operation is disabled in this candidate rather than silently mixing private-session analysis with persistent ordinary-profile caches. GitHub Enterprise hosts and Firefox are not supported by this build.
