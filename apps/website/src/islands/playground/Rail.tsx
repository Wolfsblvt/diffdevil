...
/** The rail: input tabs, public-PR input or example cards, then configuration. A hard-edged column flush with the header; the desktop rail never collapses; ≤ 900 it becomes a sticky bottom sheet. */
    ...
    <>
      ...
      <div id="panel-input" role="tabpanel" aria-labelledby={state.mode === 'pr' ? 'tab-pr' : 'tab-examples'} className="pg-input">
        {state.mode === 'pr' ? (
          ...
          <div className="stack">
            <div className="pg-kinds" role="radiogroup" aria-label="Example kind">
