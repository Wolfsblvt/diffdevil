...
check('nav has Docs, Playground, Examples, Install and FAQ; there is no top-level App item', (await page.locator('.site-nav > li').allInnerTexts()).map(t => t.trim()).join('|') === 'Docs|Playground|Examples|Install|FAQ');
